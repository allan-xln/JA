...
OPERATIONAL_RULES = [
    ...
    "Alarmes criticos ou de alta prioridade devem ser tratados com prioridade operacional.",
    "Alarmes de atencao operacional exigem acompanhamento e validacao de recorrencia.",
